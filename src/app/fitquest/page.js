          ...
          <div className="justify-center items-center overflow-hidden">
            ...
            >
              {images.map((src, index) => (
                <SwiperSlide key={index} className="flex justify-center items-center h-full"> <img src={src} alt={`Slide ${index}`} className="max-w-full max-h-full object-contain rounded-lg" /> </SwiperSlide>
              ))}
            </Swiper>
            {/* <Slider {...settings}>
                            {images.map((src, index)=> (
