        ...
        <section className={styles.subSection}>
          <div className={styles.columnContainer}>
            ...
            {/* <img
              ...
              alt="placeholder image"
            /> */}
            <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/board/UQ8HVMw4achSHFZ8b8NcGr/Relay---App-Workflow?node-id=284-1439&embed-host=share"></iframe>
          </div>
        </section>
        <section className={styles.subSection}>
          <div className={styles.columnContainer}>
