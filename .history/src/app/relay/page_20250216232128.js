    ...
    <>
      ...
      <main>
        <section className={styles["banner-section"]}>
          <img className={styles["banner-img"]} src="/relay-images/home_mockup@1.5x.png" alt="relay app homepage mockup" />
          <div className={styles["banner-info"]}>
            <div className={styles["banner-header"]}>
              ...
              <p className={styles["banner-subtitle"]}>App Development Project | Case Study</p>
            </div>
            ...
            <div className={styles["banner-overview"]}>
              ...
              <div className={styles["btn-group"]}>
                <Link className={styles["cta-btn"]} href="https://relay.arspera.com/" c>
                  <img src="/relay-images/btn_arrow.svg" alt="arrow icon" className={styles["icon24"]}/>
                  <span>View Blog</span>
                </Link>

                <Link  className={styles["cta-btn"]} href="https://www.figma.com/design/OPBMn5qhrbRMRWUSj1J58Q/Relay-Main-Screen?node-id=0-1&t=b9rDVCiFZs6dfTC7-1">
                  <img src="/relay-images/btn_arrow.svg" alt="arrow icon" className={styles["icon24"]}/>
        ...
        <section className={styles["content-section"]}>
          <div className={styles["role"]}>
            <div className={styles["temp-img"]}>img</div>
            <div>
              <h4>My Role</h4>
              <p>UI/UX Designer</p>
            </div>
