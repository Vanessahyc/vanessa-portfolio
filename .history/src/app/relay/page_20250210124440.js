        ...
        <section className={styles.subSection}>
          <div className={styles.columnContainer}>
            ...
            {/* <img
              ...
              alt="placeholder image"
            /> */}
            <iframe className="w-full" src="https://embed.figma.com/board/UQ8HVMw4achSHFZ8b8NcGr/Relay---App-Workflow?node-id=284-1439&embed-host=share" allowFullScreen></iframe>
          </div>
        </section>
        <section className={styles.subSection}>
          <div className={styles.columnContainer}>
