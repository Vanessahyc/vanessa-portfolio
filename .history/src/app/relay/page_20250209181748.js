      ...
      <main className={styles.mainContainer}>
        ...
        <section className={styles.subSection}>
          <div className={styles.subContainer}>
            <div className={styles.infoBox}>
              ...
              <figure>
                <figcaption className={styles.personaBox}>
              ...
              <figure className={styles.personaBox}>
                <figcaption>
                ...
                <img className={styles.persona} src="/relay-images/secondary_persona.png" alt="placeholder image" />
              </figure>
            </div>
        ...
        <section className={styles.flexSection}>
          <div className={styles.infoBox}>
            <h3>Branding</h3>
            <p>
                R + Eco-friendly + Radar + Side Mirror + Connection
            </p>
          </div>
            <img  className={styles.styleGuideImg} src="/relay-images/relay_branding.png" alt="placeholder image" />
        </section>
      </main>
    </>
  );
