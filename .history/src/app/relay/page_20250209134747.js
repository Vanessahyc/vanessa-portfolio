        ...
        <section className={styles.subSection}>
          ...
          <div className={styles.subContainer}>
            ...
            <figure>
                ...
                <p>Meet Joseph, a full-time software engineer and father of a 10-year-old son, struggles to arrange reliable rides due to his demanding schedule. He values a tech-driven ridesharing solution with GPS tracking and reliable network.
                </p>
            </figure>
            <figure>
                <figcaption>Secondary Persona</figcaption>
                <p>Meet Sarah, a part-time climate policy advisor, enjoys helping her community by giving kids rides but finds it hard to coordinate with busy parents. She seeks a platform that simplifies scheduling, enhances communication, and builds connection.
                </p>
            </figure>
            <img src="https://placehold.co/600x400" alt="placeholder image" />
          </div>
