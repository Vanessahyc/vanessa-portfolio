      ...
      <main>
        <section className={styles.projectSection}>
          ...
          <div className={styles.projectInfo}>
            ...
            <div className={styles["new-btn"]}>
              <Link className={styles["new-btn"]} href="https://relay.arspera.com/" c>
                <img src="/relay-images/btn_arrow.svg" alt="arrow icon" className={styles["icon24"]}/>
                <span>View Blog</span>
              </Link>

              <Link  className={styles["new-btn"]} href="https://www.figma.com/design/OPBMn5qhrbRMRWUSj1J58Q/Relay-Main-Screen?node-id=0-1&t=b9rDVCiFZs6dfTC7-1">
                <img src="/relay-images/btn_arrow.svg" alt="arrow icon" className={styles["icon24"]}/>
