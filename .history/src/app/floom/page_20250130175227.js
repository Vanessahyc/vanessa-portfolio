    ...
    <>
      ...
      <main className={styles.mainContainer}>
        <section className={`${styles.projectSection}`}>
          <Image src={selectedImage} alt="Guava Can Design" className={`${styles.mockup}`} width={5000} height={4000}/>
          <div className={styles.projectInfo}>
            ...
            <div className={styles.flavorFilter}>
              <Button onClick={()=> setSelectedImage('/images/Guava_Mockup.jpg')}>Guava</Button>
              <Button onClick={()=> setSelectedImage('/images/Orange_Mockup.jpg')}>Orange</Button>
              <Button onClick={()=> setSelectedImage('/images/Mangosteen_Mockup.jpg')}>Mangosteen</Button>
            </div>
          </div>
        </section>
        <section>
