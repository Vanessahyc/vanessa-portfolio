...
export default function Floom() {
  ...
  const [selectedDieline, setSelectedDieline] = useState('/images/Guava_Dieline.png');
        ...
        <section className={`${styles.projectSection}`}>
          ...
          <div className={styles.projectInfo}>
            ...
            <div className={styles.flavorFilter}>
              ...
              <button
                onClick={() =>
                  {setSelectedImage("/images/Mangosteen_Mockup.jpg"); setSelectedDieline('/images/Mangosteen_Dieline.png');}
                }
              >
                Mangosteen
              </button>
